 ...
 * @method static \ElPandaPe\Sentinel\Transitions\TransitionBuilder transition(\Illuminate\Database\Eloquent\Model $subject, int|string|\UnitEnum $from, int|string|\UnitEnum $to)
