...
MUTATION_PATHS = src/Support src/Context src/Http src/Diff src/Integrity src/Ledger src/Query src/Snapshot src/Pipeline src/Security src/Capture src/Concerns src/Models src/SentinelServiceProvider.php
