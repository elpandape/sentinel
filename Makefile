...
MUTATION_PATHS = src/Support src/Context src/Diff src/Integrity src/Ledger src/Snapshot src/Capture src/Concerns src/Models src/SentinelServiceProvider.php
