...
final class GoldenLedger
{
    ...
    public static function entries(): array
    {
        return [
            ...
            'an entry a worker wrote under the trace of the request that queued it' => [
                [
                    'id' => '01JGOLDEN000000000000000H8',
                    'stream' => 'tenant:acme',
                    'sequence' => 6,
                    'audit_type' => 'model',
                    'event' => 'updated',
                    ...
                    'context' => [
                        ...
                        'environment' => 'production',
                        'hostname' => 'worker-3',
                        'job' => 'App\\Jobs\\CloseInvoice',
                        'queue' => 'invoices',
                        'service_name' => 'billing',
                        'tracestate' => 'rojo=00f067aa0ba902b7,azul=1',
                    ],
                    'payload_version' => 1,
                    'algorithm' => 'sha256',
                ...
                '{"actor_id":"1","actor_type":"user","affected_rows":null,"after":null,"audit_type":"model","before":null,"changes":null,"context":{"attempts":1,"environment":"production","hostname":"worker-3","job":"App\\\\Jobs\\\\CloseInvoice","queue":"invoices","service_name":"billing","tracestate":"rojo=00f067aa0ba902b7,azul=1"},"criteria":null,"encryption":null,"event":"updated","id":"01JGOLDEN000000000000000H8","impersonator_id":null,"impersonator_type":null,"metadata":null,"occurred_at":"2026-08-26 10:00:00.000000","request_id":null,"severity":"info","source":"job","source_audit_id":null,"span_id":"00f067aa0ba902b7","subject_id":"500","subject_type":"subject","tenant_id":"acme","trace_id":"4bf92f3577b34da6a3ce929d0e0e4736","transaction_id":"01JTRANSACTION000000000000","version":null}',
                '4f43242fc15998c1ff34c8cad2b000f4121e822a034294f1e90fa230dd104849',
            ],
